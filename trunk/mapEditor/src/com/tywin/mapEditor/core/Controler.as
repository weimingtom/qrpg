...
{
	import com.tywin.mapEditor.action.ActionList;
	import com.tywin.mapEditor.action.AddSceneObject;
	import com.tywin.mapEditor.action.DeleteObject;
	import com.tywin.mapEditor.action.IAction;
	import com.tywin.mapEditor.action.MoveObject;
	import com.tywin.mapEditor.action.PasteObject;
	import com.tywin.mapEditor.core.subControler.OpenSceneFileControler;
	import com.tywin.mapEditor.core.subControler.SaveSceneXMLFile;
	...
	import com.tywin.mapEditor.rpg.AreaSprite;
	import com.tywin.mapEditor.rpg.BackGroundPic;
	import com.tywin.mapEditor.rpg.GameLayer;
	import com.tywin.mapEditor.rpg.RPGScene;
	import com.tywin.mapEditor.rpg.SceneObject;
	import com.tywin.mapEditor.wiew.CreateEmptyScene;
	import com.tywin.mapEditor.wiew.help.VersionWin;
	import com.tywin.mapEditor.wiew.menu.MainMenu;
	import com.tywin.mapEditor.wiew.propertywin.PropertyWin;
	import com.tywin.mapEditor.wiew.resourcewin.ResourceWin;
	import com.tywin.mapEditor.wiew.server.ConnectServer;
	import com.tywin.mapEditor.wiew.server.SceneDataSelect;
	import com.tywin.mapEditor.wiew.tool.Tools;
	...
	public class Controler
	{
		...
		private function orderHandler(evt:EditEvent):void
		{
			...
			//链接服务器
			else if ( evt.data.@data==OrderKey.CONNECT_SERVER )
			{
				ConnectServer.open();
			}
			//选择场景
			else if ( evt.data.@data==OrderKey.SELECT_SCENE )
			{
				SceneDataSelect.open();
			}
